...
class ModeloUsuarios
{
    ...
    static public function mdlAgregarUsuario($tabla, $datos, $contacto = null)
    {
        ...
        try {
            ...
            $stmt = $conexion->prepare("INSERT INTO $tabla (tipo_documento, documento_id, nombres, apellidos, correo, fecha_nacimiento, rol, password, fichas_id, doc_identidad_maestro_url) VALUES (:tipoDocumento, :documentoId, :nombres, :apellidos, :correo, :fechaNacimiento, :rol, :password, :ficha_id, :foto)");
